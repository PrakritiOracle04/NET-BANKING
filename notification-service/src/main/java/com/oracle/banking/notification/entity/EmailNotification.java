...
public class EmailNotification {
 ...
 public String getId(){return id;} public String getRecipient(){return recipient;} public String getSubject(){return subject;} public String getBodyPreview(){return bodyPreview;} public String getType(){return type;} public NotificationStatus getStatus(){return status;} public String getTemplateName(){return templateName;} public int getRetryCount(){return retryCount;} public Instant getCreatedAt(){return createdAt;} public Instant getSentAt(){return sentAt;}
 public void processing(){status=NotificationStatus.PROCESSING;} public void sent(){status=NotificationStatus.SENT;sentAt=Instant.now();} public void failed(){status=NotificationStatus.FAILED;} public void retrying(){status=NotificationStatus.RETRYING;retryCount++;}
}
